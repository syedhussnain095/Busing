                    ...
                    <div className="row">
                        <div className="col-sm-12 col-md-3 col-lg-3 col-xl-3 py-2">
                            ...
                            <div className="footer_logo_under">
                                <p>Lorem ipsum dolor sit amet, consect ascing elit, sed do eiusmod incididunt ut labore et dolore Many desktop lishing packages and web page editors</p>
                            </div>
                            <div className="row">
                                <div className="icons">
                                    <NavLink to="/">
                        ...
                        <div className="foot_our_services">
                                ...
                                <ul className="for_bef">
                                    ...
                                    <li>
                                        <NavLink to="/protfolio">Condition</NavLink>
                                    </li>
                                    <li>
                                        <NavLink to="/contact">Term Of Use</NavLink>
                                    </li>
                                </ul>
                                </div>
                            </div>
